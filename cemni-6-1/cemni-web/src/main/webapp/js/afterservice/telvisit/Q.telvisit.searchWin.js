...
Ext.extend(Q.telvisit.searchWin, Ext.ux.Window, {
            ...
            items : [ {
                ...
                items : [ {
                    ...
                    items : [ {
                        ...
                        displayField : "name",
                        clearable : true,
                        store : Q.telvisit.selStores.storStatus,
                        anchor : "90%"
                    }, {
                        name : "belongStoreNo",
                        xtype : "hidden"
                        ...
                        listeners : {
                            render : function(p) {
                                ...
                                p.getEl().on('click', function(p) {
                                    var _storeWin = new Q.store.chooseStoreWin({
                                        action : "attr2store",
                                        attr : _win.formPanel.getForm().findField("attr").getValue(),
                                        singleSelect : false
                                    });
                                    _storeWin.on("submit", function(r) {
                                        var codeArr = [];
    ...
    searchWin : function() {
        ...
        var json = {
            ...
            filter_NOT_IN_belongStoreNo : _form.findField("belongStoreNo").getValue(),
            filter_IN_StoreList_ATTR : _form.findField("attr").getValue(),
