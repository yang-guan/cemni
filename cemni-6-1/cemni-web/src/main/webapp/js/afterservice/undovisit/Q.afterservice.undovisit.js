    ...
    searchWin : {
        ...
        form : {
            ...
            items : [ {
                ...
                fieldLabel : '活跃状态',
                hiddenName : "filter_IN_individCust_active",
                xtype : 'lovcombo',
                valueField : "value",
                displayField : "name",
                clearable : true,
                store : Q.undovisit.selStores.activeStore
            }, {
                fieldLabel : '会员等级',
                hiddenName : "filter_IN_individCust_lv",
                xtype : 'lovcombo',
                valueField : "value",
                displayField : "name",
                clearable : true,
                store : Q.undovisit.selStores.lvStore
            }, {
                fieldLabel : '累计珠宝折算额',
                name : "filter_GE_individCust_jewerlyAmount"
            }, {
                fieldLabel : '至',
                name : "filter_LE_individCust_jewerlyAmount"
            }, {
                fieldLabel : '手机号码',
