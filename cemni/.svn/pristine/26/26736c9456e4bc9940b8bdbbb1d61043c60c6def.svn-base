...
@Entity
@Table(name = "D_SALES_SCALEDETAIL")
public class ScaleDetails extends BaseEntity<Long> {
    private static final long serialVersionUID = 1L;
    @Id
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "Sales_Scaledetail_PK")
    @TableGenerator(name = "Sales_Scaledetail_PK", table = "s_pkGenerator", pkColumnName = "PkGeneratorName", valueColumnName = "PkGeneratorValue", pkColumnValue = "Sales_Scaledetail_PK", allocationSize = 1)
    private Long scaleDetailsId;
    ...
    private Integer scaleType;// 分数段类型
    @Transient
    ...
    public Long getScaleDetailsId() {
        return scaleDetailsId;
    }

    public void setScaleDetailsId(Long scaleDetailsId) {
        this.scaleDetailsId = scaleDetailsId;
    }

    public ScaleTarget getScaleTarget() {
        return scaleTarget;
    }
